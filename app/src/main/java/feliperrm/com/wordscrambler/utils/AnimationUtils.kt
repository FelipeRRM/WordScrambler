...
object AnimationUtils {
    ...
    fun getAnimationElevation(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            val startElevationPixels = if (isDp) DimensionsUtils.convertDpToPixel(
                initialElevation,
                viewToAnimate.context
            ) else initialElevation
            val endElevationPixels =
                if (isDp) DimensionsUtils.convertDpToPixel(endElevation, viewToAnimate.context) else endElevation
